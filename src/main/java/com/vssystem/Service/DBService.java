...
import com.vssystem.Entity.Venda;
...
public class DBService {
    ...
    public void instanciaDB() {
        ...
        Produto tec1 = new Produto(null, "Valdir Cezar", "550.482.150-95", "valdir@mail.com", encoder.encode("123"));
        tec1.addPerfis(Perfil.ADMIN);
        Produto tec2 = new Produto(null, "Richard Stallman", "903.347.070-56", "stallman@mail.com", encoder.encode("123"));
        Produto tec3 = new Produto(null, "Claude Elwood Shannon", "271.068.470-54", "shannon@mail.com", encoder.encode("123"));
        Produto tec4 = new Produto(null, "Tim Berners-Lee", "162.720.120-39", "lee@mail.com", encoder.encode("123"));
        Produto tec5 = new Produto(null, "Linus Torvalds", "778.556.170-27", "linus@mail.com", encoder.encode("123"));
